...
# 데이터 저장
train_df.to_csv('/data/ephemeral/home/level1-semantictextsimilarity-nlp-07/data/npart_processed_train.csv', index=False)
val_df.to_csv('/data/ephemeral/home/level1-semantictextsimilarity-nlp-07/data/npart_processed_dev.csv', index=False)