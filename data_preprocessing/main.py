...
val_df = pd.read_csv(config["your_path"]+config["process_paths"]["dev_process_path"])
test_df = pd.read_csv(config["your_path"]+config["process_paths"]["test_process_path"])
...
# 데이터 저장
final_train_df.to_csv(config["your_path"]+'/data/final_train.csv', index=False)
final_val_df.to_csv(config["your_path"]+'/data/final_dev.csv', index=False)
final_test_df.to_csv(config["your_path"]+'/data/final_test.csv', index=False)